...
export const marketplace: TranslationModule = {
  ...
  'marketplace.drawer.gpuRequired': { zh: 'GPU 需求', en: 'GPU Required' },
  'marketplace.drawer.gpuTrue': { zh: '需要 GPU 加速', en: 'GPU Accelerated' },
  'marketplace.drawer.gpuFalse': { zh: '无需 GPU', en: 'CPU Only' },
  'marketplace.drawer.minOS': { zh: '最低固件要求', en: 'Min OS Version' },
  'marketplace.drawer.certifiedTooltip': { zh: '官方认证应用包', en: 'Certified App Pack' },
